...
public class ExtendedMessageFormat extends java.text.MessageFormat {
    ...
    public final void applyPattern(final java.lang.String pattern) {
        ...
        final java.util.ArrayList<java.text.Format> foundFormats = new java.util.ArrayList<>();
        final java.util.ArrayList<java.lang.String> foundDescriptions = new java.util.ArrayList<>();
    ...
    public int hashCode() {
        ...
        result = ((org.apache.commons.lang3.text.ExtendedMessageFormat.HASH_SEED) * result) + (java.util.Objects.hashCode(registry));
        result = ((org.apache.commons.lang3.text.ExtendedMessageFormat.HASH_SEED) * result) + (java.util.Objects.hashCode(toPattern));
        return result;
    }
