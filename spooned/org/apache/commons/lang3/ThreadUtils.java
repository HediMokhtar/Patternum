...
public class ThreadUtils {
    ...
    public static java.util.Collection<java.lang.Thread> findThreadsByName(final java.lang.String threadName, final java.lang.String threadGroupName) {
        ...
        final java.util.Collection<java.lang.Thread> result = new java.util.ArrayList<>();
    ...
    public static java.util.Collection<java.lang.ThreadGroup> getAllThreadGroups() {
        return org.apache.commons.lang3.ThreadUtils.findThreadGroups(org.apache.commons.lang3.ThreadUtils.ALWAYS_TRUE_PREDICATE);
    }
    ...
    public static java.util.Collection<java.lang.Thread> getAllThreads() {
        return org.apache.commons.lang3.ThreadUtils.findThreads(org.apache.commons.lang3.ThreadUtils.ALWAYS_TRUE_PREDICATE);
    }
    ...
    private static final class AlwaysTruePredicate implements org.apache.commons.lang3.ThreadUtils.ThreadGroupPredicate , org.apache.commons.lang3.ThreadUtils.ThreadPredicate {
    ...
    public static class NamePredicate implements org.apache.commons.lang3.ThreadUtils.ThreadGroupPredicate , org.apache.commons.lang3.ThreadUtils.ThreadPredicate {
    ...
    public static java.util.Collection<java.lang.Thread> findThreads(final org.apache.commons.lang3.ThreadUtils.ThreadPredicate predicate) {
    ...
    public static java.util.Collection<java.lang.ThreadGroup> findThreadGroups(final org.apache.commons.lang3.ThreadUtils.ThreadGroupPredicate predicate) {
    ...
    public static java.util.Collection<java.lang.Thread> findThreads(final java.lang.ThreadGroup group, final boolean recurse, final org.apache.commons.lang3.ThreadUtils.ThreadPredicate predicate) {
        if (group == null) {
        ...
        final java.util.List<java.lang.Thread> result = new java.util.ArrayList<>(count);
    ...
    public static java.util.Collection<java.lang.ThreadGroup> findThreadGroups(final java.lang.ThreadGroup group, final boolean recurse, final org.apache.commons.lang3.ThreadUtils.ThreadGroupPredicate predicate) {
        if (group == null) {
            throw new java.lang.IllegalArgumentException("The group must not be null");
        }
        if (predicate == null) {
        ...
        final java.util.List<java.lang.ThreadGroup> result = new java.util.ArrayList<>(count);
        for (int i = 0; i < count; ++i) {
