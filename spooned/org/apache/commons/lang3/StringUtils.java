...
public class StringUtils {
    ...
    public static boolean isAllEmpty(final java.lang.CharSequence... css) {
        if (org.apache.commons.lang3.ArrayUtils.isEmpty(css)) {
            return true;
        }
        for (final java.lang.CharSequence cs : css) {
            if (org.apache.commons.lang3.StringUtils.isNotEmpty(cs)) {
                return false;
            }
        }
        return true;
    ...
    public static boolean isAllBlank(final java.lang.CharSequence... css) {
        if (org.apache.commons.lang3.ArrayUtils.isEmpty(css)) {
            return true;
        }
        for (final java.lang.CharSequence cs : css) {
    ...
    public static java.lang.String truncate(final java.lang.String str, final int maxWidth) {
        return org.apache.commons.lang3.StringUtils.truncate(str, 0, maxWidth);
    }

    public static java.lang.String truncate(final java.lang.String str, final int offset, final int maxWidth) {
        if (offset < 0) {
    ...
    public static java.lang.String stripAccents(final java.lang.String input) {
        ...
        final java.lang.StringBuilder decomposed = new java.lang.StringBuilder(java.text.Normalizer.normalize(input, java.text.Normalizer.Form.NFD));
    ...
    private static void convertRemainingAccentCharacters(final java.lang.StringBuilder decomposed) {
    ...
    public static boolean equalsAny(final java.lang.CharSequence string, final java.lang.CharSequence... searchStrings) {
        if (org.apache.commons.lang3.ArrayUtils.isNotEmpty(searchStrings)) {
            for (final java.lang.CharSequence next : searchStrings) {
    ...
    public static boolean containsAny(final java.lang.CharSequence cs, final java.lang.CharSequence... searchCharSequences) {
        if ((org.apache.commons.lang3.StringUtils.isEmpty(cs)) || (org.apache.commons.lang3.ArrayUtils.isEmpty(searchCharSequences))) {
            return false;
        }
        for (final java.lang.CharSequence searchCharSequence : searchCharSequences) {
    ...
    public static int indexOfAny(final java.lang.CharSequence str, final java.lang.CharSequence... searchStrs) {
        ...
        int tmp = 0;
        for (final java.lang.CharSequence search : searchStrs) {
            if (search == null) {
                continue;
            }
    ...
    public static java.lang.String[] substringsBetween(final java.lang.String str, final java.lang.String open, final java.lang.String close) {
        ...
        final java.util.List<java.lang.String> list = new java.util.ArrayList<>();
        int pos = 0;
    ...
    private static java.lang.String[] splitByWholeSeparatorWorker(final java.lang.String str, final java.lang.String separator, final int max, final boolean preserveAllTokens) {
        ...
        final java.util.ArrayList<java.lang.String> substrings = new java.util.ArrayList<>();
    ...
    public static java.lang.String join(final java.util.Iterator<?> iterator, final char separator) {
        ...
        if (!(iterator.hasNext())) {
            final java.lang.String result = java.util.Objects.toString(first, "");
            return result;
        }
    ...
    public static java.lang.String joinWith(final java.lang.String separator, final java.lang.Object... objects) {
        ...
        final java.lang.String sanitizedSeparator = org.apache.commons.lang3.StringUtils.defaultString(separator, org.apache.commons.lang3.StringUtils.EMPTY);
        ...
        while (iterator.hasNext()) {
            final java.lang.String value = java.util.Objects.toString(iterator.next(), "");
            result.append(value);
            if (iterator.hasNext()) {
    ...
    public static java.lang.String removeIgnoreCase(final java.lang.String str, final java.lang.String remove) {
        if ((org.apache.commons.lang3.StringUtils.isEmpty(str)) || (org.apache.commons.lang3.StringUtils.isEmpty(remove))) {
            return str;
        }
        return org.apache.commons.lang3.StringUtils.replaceIgnoreCase(str, remove, org.apache.commons.lang3.StringUtils.EMPTY, (-1));
    }
    ...
    public static java.lang.String removeAll(final java.lang.String text, final java.lang.String regex) {
        return org.apache.commons.lang3.StringUtils.replaceAll(text, regex, org.apache.commons.lang3.StringUtils.EMPTY);
    }

    public static java.lang.String removeFirst(final java.lang.String text, final java.lang.String regex) {
        return org.apache.commons.lang3.StringUtils.replaceFirst(text, regex, org.apache.commons.lang3.StringUtils.EMPTY);
    }
    ...
    public static java.lang.String replaceOnceIgnoreCase(final java.lang.String text, final java.lang.String searchString, final java.lang.String replacement) {
        return org.apache.commons.lang3.StringUtils.replaceIgnoreCase(text, searchString, replacement, 1);
    }
    ...
    public static java.lang.String replaceIgnoreCase(final java.lang.String text, final java.lang.String searchString, final java.lang.String replacement) {
        return org.apache.commons.lang3.StringUtils.replaceIgnoreCase(text, searchString, replacement, (-1));
    }

    public static java.lang.String replace(final java.lang.String text, final java.lang.String searchString, final java.lang.String replacement, final int max) {
        return org.apache.commons.lang3.StringUtils.replace(text, searchString, replacement, max, false);
    }

    private static java.lang.String replace(final java.lang.String text, java.lang.String searchString, final java.lang.String replacement, int max, final boolean ignoreCase) {
        ...
        java.lang.String searchText = text;
        if (ignoreCase) {
    ...
    public static java.lang.String replaceIgnoreCase(final java.lang.String text, final java.lang.String searchString, final java.lang.String replacement, final int max) {
        return org.apache.commons.lang3.StringUtils.replace(text, searchString, replacement, max, true);
    }
    ...
    public static java.lang.String capitalize(final java.lang.String str) {
        ...
        final int newCodePoint = java.lang.Character.toTitleCase(firstCodepoint);
        ...
        for (int inOffset = java.lang.Character.charCount(firstCodepoint); inOffset < strLen;) {
            final int codepoint = str.codePointAt(inOffset);
            newCodePoints[(outOffset++)] = codepoint;
            inOffset += java.lang.Character.charCount(codepoint);
        }
        return new java.lang.String(newCodePoints, 0, outOffset);
    }
    ...
    public static java.lang.String uncapitalize(final java.lang.String str) {
        ...
        final int firstCodepoint = str.codePointAt(0);
        final int newCodePoint = java.lang.Character.toLowerCase(firstCodepoint);
        if (firstCodepoint == newCodePoint) {
            return str;
        }
        final int[] newCodePoints = new int[strLen];
    ...
    public static java.lang.String swapCase(final java.lang.String str) {
        ...
        for (int i = 0; i < strLen;) {
            ...
            if (java.lang.Character.isUpperCase(oldCodepoint)) {
                newCodePoint = java.lang.Character.toLowerCase(oldCodepoint);
            }else
                if (java.lang.Character.isTitleCase(oldCodepoint)) {
                    newCodePoint = java.lang.Character.toLowerCase(oldCodepoint);
                }else
                    if (java.lang.Character.isLowerCase(oldCodepoint)) {
                        newCodePoint = java.lang.Character.toUpperCase(oldCodepoint);
                    }else {
            ...
            newCodePoints[(outOffset++)] = newCodePoint;
            i += java.lang.Character.charCount(newCodePoint);
        }
        return new java.lang.String(newCodePoints, 0, outOffset);
    }
    ...
    public static java.lang.String rotate(final java.lang.String str, final int shift) {
        if (str == null) {
            return null;
        }
        final int strLen = str.length();
    ...
    public static java.lang.String abbreviate(final java.lang.String str, final int maxWidth) {
        final java.lang.String defaultAbbrevMarker = "...";
        return org.apache.commons.lang3.StringUtils.abbreviate(str, defaultAbbrevMarker, 0, maxWidth);
    }

    public static java.lang.String abbreviate(final java.lang.String str, final int offset, final int maxWidth) {
        final java.lang.String defaultAbbrevMarker = "...";
        return org.apache.commons.lang3.StringUtils.abbreviate(str, defaultAbbrevMarker, offset, maxWidth);
    }

    public static java.lang.String abbreviate(final java.lang.String str, final java.lang.String abbrevMarker, final int maxWidth) {
        return org.apache.commons.lang3.StringUtils.abbreviate(str, abbrevMarker, 0, maxWidth);
    }

    public static java.lang.String abbreviate(final java.lang.String str, final java.lang.String abbrevMarker, int offset, final int maxWidth) {
        if ((org.apache.commons.lang3.StringUtils.isEmpty(str)) || (org.apache.commons.lang3.StringUtils.isEmpty(abbrevMarker))) {
            return str;
        }
        ...
        if (maxWidth < minAbbrevWidth) {
            throw new java.lang.IllegalArgumentException(java.lang.String.format("Minimum abbreviation width is %d", minAbbrevWidth));
        }
        if ((str.length()) <= maxWidth) {
            return str;
        }
        ...
        if (maxWidth < minAbbrevWidthOffset) {
            throw new java.lang.IllegalArgumentException(java.lang.String.format("Minimum abbreviation width with offset is %d", minAbbrevWidthOffset));
        }
        if (((offset + maxWidth) - abbrevMarkerLength) < (str.length())) {
            return abbrevMarker + (org.apache.commons.lang3.StringUtils.abbreviate(str.substring(offset), abbrevMarker, (maxWidth - abbrevMarkerLength)));
        }
    ...
    public static int indexOfDifference(final java.lang.CharSequence... css) {
        ...
        int longestStrLen = 0;
        for (java.lang.CharSequence cs : css) {
            if (cs == null) {
                anyStringNull = true;
                shortestStrLen = 0;
            }else {
                allStringsNull = false;
                shortestStrLen = java.lang.Math.min(cs.length(), shortestStrLen);
                longestStrLen = java.lang.Math.max(cs.length(), longestStrLen);
            }
        }
    ...
    public static int getLevenshteinDistance(java.lang.CharSequence s, java.lang.CharSequence t) {
        ...
        for (j = 1; j <= m; j++) {
            ...
            for (i = 1; i <= n; i++) {
                ...
                p[i] = java.lang.Math.min(java.lang.Math.min(((p[(i - 1)]) + 1), ((p[i]) + 1)), (upper_left + cost));
                upper_left = upper;
            }
        }
        return p[n];
    ...
    public static int getLevenshteinDistance(java.lang.CharSequence s, java.lang.CharSequence t, final int threshold) {
        ...
        if (n == 0) {
            ...
            if (m == 0) {
                ...
                if ((java.lang.Math.abs((n - m))) > threshold) {
                    return -1;
                }
    ...
    public static double getJaroWinklerDistance(final java.lang.CharSequence first, final java.lang.CharSequence second) {
        ...
        final int[] mtp = org.apache.commons.lang3.StringUtils.matches(first, second);
        final double m = mtp[0];
        if (m == 0) {
            return 0.0;
        }
        final double j = (((m / (first.length())) + (m / (second.length()))) + ((m - (mtp[1])) / m)) / 3;
        final double jw = j < 0.7 ? j : j + (((java.lang.Math.min(DEFAULT_SCALING_FACTOR, (1.0 / (mtp[3])))) * (mtp[2])) * (1.0 - j));
        return (java.lang.Math.round((jw * 100.0))) / 100.0;
    }

    private static int[] matches(final java.lang.CharSequence first, final java.lang.CharSequence second) {
        java.lang.CharSequence max;
        java.lang.CharSequence min;
        ...
        final int range = java.lang.Math.max((((max.length()) / 2) - 1), 0);
        ...
        for (int mi = 0; mi < (min.length()); mi++) {
            ...
            for (int xi = java.lang.Math.max((mi - range), 0), xn = java.lang.Math.min(((mi + range) + 1), max.length()); xi < xn; xi++) {
    ...
    public static boolean startsWithAny(final java.lang.CharSequence sequence, final java.lang.CharSequence... searchStrings) {
        if ((org.apache.commons.lang3.StringUtils.isEmpty(sequence)) || (org.apache.commons.lang3.ArrayUtils.isEmpty(searchStrings))) {
            return false;
        }
        for (final java.lang.CharSequence searchString : searchStrings) {
            if (org.apache.commons.lang3.StringUtils.startsWith(sequence, searchString)) {
                return true;
            }
        }
        return false;
    ...
    public static java.lang.String normalizeSpace(final java.lang.String str) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            final boolean isWhitespace = java.lang.Character.isWhitespace(actualChar);
            if (!isWhitespace) {
                ...
                if ((whitespacesCount == 0) && (!startWhitespaces)) {
                    newChars[(count++)] = org.apache.commons.lang3.StringUtils.SPACE.charAt(0);
                }
                whitespacesCount++;
            }
        }
        ...
        return new java.lang.String(newChars, 0, (count - (whitespacesCount > 0 ? 1 : 0))).trim();
    }

    public static boolean endsWithAny(final java.lang.CharSequence sequence, final java.lang.CharSequence... searchStrings) {
        if ((org.apache.commons.lang3.StringUtils.isEmpty(sequence)) || (org.apache.commons.lang3.ArrayUtils.isEmpty(searchStrings))) {
            return false;
        }
        for (final java.lang.CharSequence searchString : searchStrings) {
            if (org.apache.commons.lang3.StringUtils.endsWith(sequence, searchString)) {
                return true;
            }
        }
        return false;
    ...
    public static java.lang.String wrapIfMissing(final java.lang.String str, final char wrapWith) {
        if ((org.apache.commons.lang3.StringUtils.isEmpty(str)) || (wrapWith == ' ')) {
            return str;
        }
        final java.lang.StringBuilder builder = new java.lang.StringBuilder(((str.length()) + 2));
    ...
    public static java.lang.String wrapIfMissing(final java.lang.String str, final java.lang.String wrapWith) {
        if ((org.apache.commons.lang3.StringUtils.isEmpty(str)) || (org.apache.commons.lang3.StringUtils.isEmpty(wrapWith))) {
            return str;
        }
        final java.lang.StringBuilder builder = new java.lang.StringBuilder((((str.length()) + (wrapWith.length())) + (wrapWith.length())));
    ...
    public static java.lang.String unwrap(final java.lang.String str, final java.lang.String wrapToken) {
        if ((org.apache.commons.lang3.StringUtils.isEmpty(str)) || (org.apache.commons.lang3.StringUtils.isEmpty(wrapToken))) {
            return str;
        }
        if ((org.apache.commons.lang3.StringUtils.startsWith(str, wrapToken)) && (org.apache.commons.lang3.StringUtils.endsWith(str, wrapToken))) {
    ...
    public static java.lang.String unwrap(final java.lang.String str, final char wrapChar) {
        if ((org.apache.commons.lang3.StringUtils.isEmpty(str)) || (wrapChar == ' ')) {
            return str;
        }
    ...
    public static int[] toCodePoints(java.lang.CharSequence str) {
        if (str == null) {
            return null;
        }
        if ((str.length()) == 0) {
        ...
        java.lang.String s = str.toString();
        int[] result = new int[s.codePointCount(0, s.length())];
        int index = 0;
        for (int i = 0; i < (result.length); i++) {
            result[i] = s.codePointAt(index);
            index += java.lang.Character.charCount(result[i]);
        }
        return result;
    }
}
