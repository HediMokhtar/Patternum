...
public class ObjectUtils {
    ...
    public static boolean anyNotNull(final java.lang.Object... values) {
        return (org.apache.commons.lang3.ObjectUtils.firstNonNull(values)) != null;
    }

    public static boolean allNotNull(final java.lang.Object... values) {
        if (values == null) {
            return false;
        }
        for (final java.lang.Object val : values) {
            if (val == null) {
                return false;
            }
        }
    ...
    public static java.lang.String toString(final java.lang.Object obj) {
        return obj == null ? org.apache.commons.lang3.StringUtils.EMPTY : obj.toString();
    }
    ...
    public static <T extends java.lang.Comparable<? super T>> T median(final T... items) {
        ...
        final java.util.TreeSet<T> sort = new java.util.TreeSet<>();
    ...
    public static <T> T median(final java.util.Comparator<T> comparator, final T... items) {
        ...
        final java.util.TreeSet<T> sort = new java.util.TreeSet<>(comparator);
        java.util.Collections.addAll(sort, items);
        @java.lang.SuppressWarnings(value = "unchecked")
        final T result = ((T) (sort.toArray()[(((sort.size()) - 1) / 2)]));
        return result;
    ...
    public static <T> T mode(final T... items) {
        if (org.apache.commons.lang3.ArrayUtils.isNotEmpty(items)) {
            final java.util.HashMap<T, org.apache.commons.lang3.mutable.MutableInt> occurrences = new java.util.HashMap<>(items.length);
            for (final T t : items) {
