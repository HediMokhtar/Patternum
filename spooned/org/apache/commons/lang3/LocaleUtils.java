...
public class LocaleUtils {
    private static final java.util.concurrent.ConcurrentMap<java.lang.String, java.util.List<java.util.Locale>> cLanguagesByCountry = new java.util.concurrent.ConcurrentHashMap<>();

    private static final java.util.concurrent.ConcurrentMap<java.lang.String, java.util.List<java.util.Locale>> cCountriesByLanguage = new java.util.concurrent.ConcurrentHashMap<>();
    ...
    public static java.util.Locale toLocale(final java.lang.String str) {
        ...
        if (str.isEmpty()) {
            return new java.util.Locale(org.apache.commons.lang3.StringUtils.EMPTY, org.apache.commons.lang3.StringUtils.EMPTY);
        }
        if (str.contains("#")) {
        ...
        if (ch0 == '_') {
            ...
            if (len == 3) {
                return new java.util.Locale(org.apache.commons.lang3.StringUtils.EMPTY, str.substring(1, 3));
            }
            if (len < 5) {
                throw new java.lang.IllegalArgumentException(("Invalid locale format: " + str));
            }
            ...
            return new java.util.Locale(org.apache.commons.lang3.StringUtils.EMPTY, str.substring(1, 3), str.substring(4));
        }
        ...
        switch (occurrences) {
            case 0 :
                ...
                throw new java.lang.IllegalArgumentException(("Invalid locale format: " + str));
            case 1 :
                if ((((org.apache.commons.lang3.StringUtils.isAllLowerCase(split[0])) && (((split[0].length()) == 2) || ((split[0].length()) == 3))) && (((split[1].length()) == 2) && (org.apache.commons.lang3.StringUtils.isAllUpperCase(split[1])))) || (((split[1].length()) == 3) && (org.apache.commons.lang3.StringUtils.isNumeric(split[1])))) {
    ...
    public static java.util.List<java.util.Locale> localeLookupList(final java.util.Locale locale, final java.util.Locale defaultLocale) {
        final java.util.List<java.util.Locale> list = new java.util.ArrayList<>(4);
        if (locale != null) {
            list.add(locale);
    ...
    static class SyncAvoid {
        ...
        static {
            final java.util.List<java.util.Locale> list = new java.util.ArrayList<>(java.util.Arrays.asList(java.util.Locale.getAvailableLocales()));
            AVAILABLE_LOCALE_LIST = java.util.Collections.unmodifiableList(list);
            AVAILABLE_LOCALE_SET = java.util.Collections.unmodifiableSet(new java.util.HashSet<>(list));
        }
    }
}
