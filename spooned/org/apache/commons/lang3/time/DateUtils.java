...
TRUNCATE, ROUND, CEILING;    }
    ...
    public static java.util.Date parseDateStrictly(final java.lang.String str, final java.util.Locale locale, final java.lang.String... parsePatterns) throws java.text.ParseException {
        return org.apache.commons.lang3.time.DateUtils.parseDateWithLeniency(str, locale, parsePatterns, false);
    }
    ...
    private static java.util.Date parseDateWithLeniency(final java.lang.String str, final java.util.Locale locale, final java.lang.String[] parsePatterns, final boolean lenient) throws java.text.ParseException {
        ...
        for (final java.lang.String parsePattern : parsePatterns) {
            final org.apache.commons.lang3.time.FastDateParser fdp = new org.apache.commons.lang3.time.FastDateParser(parsePattern, tz, lcl);
            calendar.clear();
            try {
                if ((fdp.parse(str, pos, calendar)) && ((pos.getIndex()) == (str.length()))) {
                    return calendar.getTime();
                }
            } catch (final java.lang.IllegalArgumentException ignore) {
            }
            pos.setIndex(0);
        }
    ...
    public static java.util.Calendar toCalendar(final java.util.Date date, final java.util.TimeZone tz) {
        final java.util.Calendar c = java.util.Calendar.getInstance(tz);
        c.setTime(date);
        return c;
    }
    ...
    public static java.util.Date round(final java.util.Date date, final int field) {
        ...
        gval.setTime(date);
        org.apache.commons.lang3.time.DateUtils.modify(gval, field, org.apache.commons.lang3.time.DateUtils.ModifyType.ROUND);
        return gval.getTime();
    }
    ...
    private static void modify(final java.util.Calendar val, final int field, final org.apache.commons.lang3.time.DateUtils.ModifyType modType) {
        ...
        if (((org.apache.commons.lang3.time.DateUtils.ModifyType.TRUNCATE) == modType) || (millisecs < 500)) {
            time = time - millisecs;
        }
        ...
        if ((!done) && (((org.apache.commons.lang3.time.DateUtils.ModifyType.TRUNCATE) == modType) || (seconds < 30))) {
        ...
        if ((!done) && (((org.apache.commons.lang3.time.DateUtils.ModifyType.TRUNCATE) == modType) || (minutes < 30))) {
        ...
        for (final int[] aField : org.apache.commons.lang3.time.DateUtils.fields) {
            for (final int element : aField) {
                if (element == field) {
                    if ((modType == (org.apache.commons.lang3.time.DateUtils.ModifyType.CEILING)) || ((modType == (org.apache.commons.lang3.time.DateUtils.ModifyType.ROUND)) && roundUp)) {
