...
public class DiffResult implements java.lang.Iterable<org.apache.commons.lang3.builder.Diff<?>> {
    ...
    public java.lang.String toString(final org.apache.commons.lang3.builder.ToStringStyle style) {
        if ((diffs.size()) == 0) {
            return org.apache.commons.lang3.builder.DiffResult.OBJECTS_SAME_STRING;
        }
        ...
        return java.lang.String.format("%s %s %s", lhsBuilder.build(), org.apache.commons.lang3.builder.DiffResult.DIFFERS_STRING, rhsBuilder.build());
    }
