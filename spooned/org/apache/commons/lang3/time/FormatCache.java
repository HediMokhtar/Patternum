...
abstract class FormatCache<F extends java.text.Format> {
    ...
    private final java.util.concurrent.ConcurrentMap<org.apache.commons.lang3.time.FormatCache.MultipartKey, F> cInstanceCache = new java.util.concurrent.ConcurrentHashMap<>(7);

    private static final java.util.concurrent.ConcurrentMap<org.apache.commons.lang3.time.FormatCache.MultipartKey, java.lang.String> cDateTimeInstanceCache = new java.util.concurrent.ConcurrentHashMap<>(7);
    ...
    static java.lang.String getPatternForStyle(final java.lang.Integer dateStyle, final java.lang.Integer timeStyle, final java.util.Locale locale) {
        ...
        java.lang.String pattern = org.apache.commons.lang3.time.FormatCache.cDateTimeInstanceCache.get(key);
        if (pattern == null) {
            try {
                ...
                final java.lang.String previous = org.apache.commons.lang3.time.FormatCache.cDateTimeInstanceCache.putIfAbsent(key, pattern);
                if (previous != null) {
                    pattern = previous;
                }
