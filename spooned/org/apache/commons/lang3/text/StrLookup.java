...
public abstract class StrLookup<V> {
    private static final org.apache.commons.lang3.text.StrLookup<java.lang.String> NONE_LOOKUP = new org.apache.commons.lang3.text.StrLookup.MapStrLookup<>(null);
    ...
    public static <V> org.apache.commons.lang3.text.StrLookup<V> mapLookup(final java.util.Map<java.lang.String, V> map) {
        return new org.apache.commons.lang3.text.StrLookup.MapStrLookup<>(map);
    }
    ...
    private static class SystemPropertiesStrLookup extends org.apache.commons.lang3.text.StrLookup<java.lang.String> {
        ...
        public java.lang.String lookup(final java.lang.String key) {
            if ((key.length()) > 0) {
                ...
                } catch (final java.lang.SecurityException scex) {
                }
            }
            return null;
        }
